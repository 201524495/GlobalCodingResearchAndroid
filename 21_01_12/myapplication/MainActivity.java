    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) { //버튼1 클릭 시 
                Toast.makeText(MainActivity.this, "Main Layout", Toast.LENGTH_SHORT).show();
                if (flag) { //클릭하면 바뀌고
        ...
        Button button1 = (Button) findViewById(R.id.Main_Sub);
        ...
        Button button2 = (Button) findViewById(R.id.Main_Bluetooth);
